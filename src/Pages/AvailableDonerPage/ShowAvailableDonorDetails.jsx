...
const ShowAvailableDonorDetails = () => {
  ...
  return (
    <MyContainer>
      ...
      <div className="w-[98%] md:w-[80%] lg:w-[70%] mx-auto my-2 md:my-5">
        <Link
          to={location.state || "/"}
        ...
        <div className="p-5 rounded-lg shadow-lg bg-white flex flex-col md:flex-row gap-2 md:gap-5 border">
          {/* img && social links */}
