...
//         ) : (
//           //  <LoadingAnimation />
//           <div className="min-h-screen flex justify-center items-center bg-[url('https://i.ibb.co/10kGMgs/Cover-EBE-1170x675.jpg')] bg-no-repeat bg-cover">
//             <WebsiteTitle name={"Registration"} />
//             <div className="backdrop-blur-xl h-full min-h-screen py-5">
//               <div className="p-border rounded-md min-h-screen md:w-[70%] pt-2 mx-auto backdrop-blur-xl">
//                 <form onSubmit={handleRegister}>
//                   {/* Image */}
//                   <div className="">
//                     <div className="relative border rounded-full h-28 w-28 md:h-28 md:w-28 mx-auto">
//                       {showName?.name ? (
//                         <img
//                           className="h-28 w-28 md:h-28 md:w-28 rounded-full mx-auto"
//                           src={showImagePreview}
...
//                     </Link>
//                   </div>
//                   <div className="grid grid-cols-2 gap-5 md:gap-0 p-5">
//                     {/* labels */}
//                     <div className="grid gap-2 place-items-star">
//                       <label className="text-base md:text-xl font-semibold">
//                         Name:*
//                       </label>
//                       <label className="text-base md:text-xl font-semibold">
...
//                         Password:*
//                       </label>
//                       <label className="text-base md:text-xl font-semibold row-span-3">
//                         Marital Status
//                       </label>
//                       <label className="text-base md:text-xl font-semibold">
//                         Religion:*
...
//                         className="input-field text-sm md:text-xl font-medium"
//                       />
//                       <div className="flex flex-wrap gap text-center text-base md:text-xl font-semibold row-span-3">
//                         {maritalStatusOptions?.map((status, ind) => (
//                           <div
//                             key={ind}
//                             className="text-xl flex flex-row-reverse items-center gap-[6px]"
